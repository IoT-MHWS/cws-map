...
std::ostream & operator<<(std::ostream & out, const SimulationStatus & status) {
  switch(status) {
    case SimulationStatus::RUNNING: out << "RUNNING";
      break;
    case SimulationStatus::STOPPED: out << "STOPPED";
      break;
    default: out << "UNKNOWN";
  }
  return out;
...
std::ostream & operator<<(std::ostream & out, const SimulationType & status) {
  switch(status) {
    case SimulationType::INFINITE: out << "INFINITE";
      break;
    case SimulationType::LIMITED: out << "LIMITED";
      break;
    default: out << "UNKNOWN";
  }
  return out;
